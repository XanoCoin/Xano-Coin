...
RESOURCES += src/qt/Xano.qrc src/qt/Xano_locale.qrc

TRANSLATIONS += src/qt/locale/Xano_bg.ts \
                src/qt/locale/Xano_de.ts \
                src/qt/locale/Xano_en.ts \
                src/qt/locale/Xano_es.ts \
                src/qt/locale/Xano_fi.ts \
                src/qt/locale/Xano_fr.ts \
                src/qt/locale/Xano_it.ts \
                src/qt/locale/Xano_ja.ts \
                src/qt/locale/Xano_pl.ts \
                src/qt/locale/Xano_pt.ts \
                src/qt/locale/Xano_ru.ts \
                src/qt/locale/Xano_sk.ts \
                src/qt/locale/Xano_sv.ts \
                src/qt/locale/Xano_vi.ts \
                src/qt/locale/Xano_zh_CN.ts \
                src/qt/locale/Xano_zh_TW.ts
