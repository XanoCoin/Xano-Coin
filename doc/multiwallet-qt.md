...
In order to support loading of multiple wallets in Xano-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Xano.cpp.
...
Changes to Xano.cpp
----------------------
Xano.cpp is the entry point into Xano-qt, and as such, will require some minor modifications to provide hooks for
