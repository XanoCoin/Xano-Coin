...
Xano now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<Xano_address\> \<monthly_payment_Xano\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Xano, _12_ times over the course of a year totaling _24000_ Xano.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<Xano_address\> \<monthly_payment_Xano\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` Xano.
