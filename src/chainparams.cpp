...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000716e656494e78f20f61bc5c737c2de518c15cd97fc3a59d79c809494556"));
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 8250;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Xano starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 20; // Xano: 
        nTargetSpacing = 1 * 45;  // Xano: 45 Seconds
        nMaturity = 10;
        ...
        nZerocoinStartTime = 1529508249; //  Wednesday, 20 June 2018 15:24:09 - (Still requires block 501)
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Final sum for Brexit divorce bill shrouded in uncertainty - 16 June 2018'";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 75 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04e80e83b2703ccf322f7dbd62dd5855ac7c10bd055814ce121ba32607d573b8810c02c0582aed05b4deb9c4b77b26d92428c61256cd42774babea0a073b2ed0c9") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1529162759;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1029679;
        ...
        strObfuscationPoolDummyAddress = "XanoEXjDK5AiCAq4hofpBz2dqawfnEsPem";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Xano: 1 day
        nTargetSpacing = 1 * 60;  // Xano: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Xano addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Xano script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet Xano BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Xano BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Xano BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Xano: 1 day
        nTargetSpacing = 1 * 60;        // Xano: 1 minutes
