...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Xano features */
        {"Xano", "masternode", &masternode, true, true, false},
        {"Xano", "listmasternodes", &listmasternodes, true, true, false},
        {"Xano", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Xano", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Xano", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Xano", "masternodedebug", &masternodedebug, true, true, false},
        {"Xano", "startmasternode", &startmasternode, true, true, false},
        {"Xano", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Xano", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Xano", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Xano", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Xano", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Xano", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Xano", "mnbudget", &mnbudget, true, true, false},
        {"Xano", "preparebudget", &preparebudget, true, true, false},
        {"Xano", "submitbudget", &submitbudget, true, true, false},
        {"Xano", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Xano", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Xano", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Xano", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Xano", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Xano", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Xano", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Xano", "checkbudgets", &checkbudgets, true, true, false},
        {"Xano", "mnsync", &mnsync, true, true, false},
        {"Xano", "spork", &spork, true, true, false},
        {"Xano", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Xano", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Xanod, or the -server option to Xano-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Xano-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8249/\n";
}
