                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Xano Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Xano address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Xano: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXANO"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Xano Core"), this);
    aboutAction->setStatusTip(tr("Show information about Xano Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Xano"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Xano addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Xano addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagXanotic information"));
    ...
    openAction->setStatusTip(tr("Open a Xano: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Xano Core help message to get a list with possible Xano command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Xano Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Xano network", "", count));
}
...
{
    QString strTitle = tr("Xano Core"); // default title
...
/** Creates context menu, its actions, and Xanos up all the relevant signals for mouse events. */
