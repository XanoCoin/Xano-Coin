                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Xano from zXano"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zXano"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXano));
