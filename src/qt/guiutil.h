...
/** Utility functions used by the Xano Qt UI.
 */
namespace GUIUtil
{
...
// Render Xano addresses in moXanopace font
...
// Parse "Xano:" URI into recipient object, return true on successful parsing
