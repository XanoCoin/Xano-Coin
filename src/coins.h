...
/** 
    ...
    ****Note - for Xano we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of Xano coming in to a transaction
