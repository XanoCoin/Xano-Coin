Contributing to Xano Core
============================

The Xano Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Xano Core project, and is not to be
confused with overall Xano Network Protocol consensus changes.

Whether a pull request is merged into Xano Core rests with the project merge
...
Patches that change Xano consensus rules are considerably more involved than
...
Where a patch set proposes to change the Xano consensus, it must have been
...
The project leader is the release manager for each Xano Core release.
